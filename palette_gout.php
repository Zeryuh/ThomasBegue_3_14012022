    ...
    <main class="global container">
        ...
        <div class="menu__global">
            <section class="menu">
                ...
                <section class="plat">
                    <div class="plat__name">
                        <h3 class="plat__name__title">Fricassée d'escargot</h3>
                ...
                <section class="plat">
                    <div class="plat__name">
                        <h3 class="plat__name__title">Foie gras de canard mi-cuit</h3>
                ...
                <section class="plat">
                    <div class="plat__name">
                        <h3 class="plat__name__title">Oeuf au plat</h3>
            ...
            <section class="menu">
                ...
                <section class="plat">
                    <div class="plat__name">
                        <h3 class="plat__name__title">Filet de boeuf aux herbes</h3>
                ...
                <section class="plat">
                    <div class="plat__name">
                        <h3 class="plat__name__title">Parmentier de queue de boeuf</h3>
                ...
                <section class="plat">
                    <div class="plat__name">
                        <h3 class="plat__name__title">Filet de turbot</h3>
            ...
            <section class="menu">
                ...
                <section class="plat">
                    <div class="plat__name">
                        <h3 class="plat__name__title">Paris-Brest</h3>
                ...
                <section class="plat">
                    <div class="plat__name">
                        <h3 class="plat__name__title">Macaron au chocolat d'exception </h3>
                ...
                <section class="plat">
                    <div class="plat__name">
                        <h3 class="plat__name__title">Mousse au chocolat </h3>
